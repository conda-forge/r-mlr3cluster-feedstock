...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-mlr3cluster-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-mlr3cluster-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-mlr3cluster
# for installing globally
pixi global install r-mlr3cluster
```
...
It is possible to list all of the versions of `r-mlr3cluster` available on your platform:
...
```
pixi search r-mlr3cluster --channel conda-forge
```
