...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-mlr3cluster-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11748&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-mlr3cluster-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-mlr3cluster` can be installed with:

```
conda install r-mlr3cluster
```

It is possible to list all of the versions of `r-mlr3cluster` available on your platform with:
